...
# %%
def compare_lentis_era_anom(country):
    ...
    plt.ylabel("Density")
    plt.title(f"PDF of event T2m anomalies in {country}")
    ...
    plt.ylabel("Density")
    plt.title(f"PDF of event 10m wind speed anomalies in {country}")

    plt.show()
    # return temp_era5_region


compare_lentis_era_anom("NLD")
# %%
